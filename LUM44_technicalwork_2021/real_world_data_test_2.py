...
perf_data_7 = pd.read_csv('real_world_7_normalised_1.csv')
...
#make train and test set fish relative
...
perf_data_1 = pd.read_csv('real_world_7_normalised_2.csv')
...
#make data camera relative again
cam_rel = full_library2.camera_relative(result,perf_data_1, 'midx1', 'midy1')

fig, ax = plt.subplots(figsize=(10,6))
ax.plot(cam_rel['midx4'], color='red', label = 'Normal')
ax.plot(perf_data_1['midx4'], color='black', label = 'Normal')
plt.show();

#test imputation sucess
full_library2.contexual_anomaly_imputation_test (luke,perfect)
